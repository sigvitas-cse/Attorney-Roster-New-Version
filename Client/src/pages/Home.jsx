        ...
        <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
          <div className="text-center lg:text-left relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <button
                className="px-6 py-3 bg-transparent border-2 border-[#38BDF8] text-[#38BDF8] text-base font-medium rounded-lg hover:bg-[#38BDF8] hover:text-white transition-all duration-200 shadow-md focus:outline-none focus:ring-2 focus:ring-[#38BDF8]"
